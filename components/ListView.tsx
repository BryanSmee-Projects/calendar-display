          ...
          return (
            <div key={dateStr} className="flex gap-6">
              <div className="flex flex-col items-center w-16 pt-1 flex-shrink-0">
                <span className="text-xs font-bold text-gray-400 uppercase">{format(date, 'EEE', { locale })}</span>
                <span className="text-2xl font-bold text-gray-900">{format(date, 'd', { locale })}</span>
              </div>
                ...
                {dayEvents.map(event => {
                  ...
                  return (
                    <div 
                      ...
                      className="group flex flex-col sm:flex-row gap-3 p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all cursor-pointer bg-white"
